		...
		<div className="min-h-[calc(100vh-200px)] flex items-center justify-center">
			<div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
				...
				<div className="hidden lg:flex flex-col justify-center bg-gradient-to-br from-[#40513B] via-[#609966] to-[#40513B] rounded-3xl p-12 text-white shadow-2xl relative overflow-hidden">
					...
					<div className="relative z-10">
						...
						<p className="text-xl text-white/90 mb-8">
							Continue your wildlife conservation journey and share your amazing
						...
						<div className="space-y-4">
							<div className="flex items-center space-x-3">
								...
								<p className="text-white/90">Document wildlife sightings</p>
							</div>
							<div className="flex items-center space-x-3">
								<div className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center text-2xl">
									🏆
								</div>
								<p className="text-white/90">Earn points and rewards</p>
							</div>
							<div className="flex items-center space-x-3">
								<div className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center text-2xl">
									🤝
								</div>
								<p className="text-white/90">Connect with nature lovers</p>
							</div>
						</div>
					</div>
				</div>
				...
				<div className="bg-white/90 backdrop-blur-sm rounded-3xl p-8 md:p-12 shadow-xl border border-[#9DC08B]/20">
					<div className="mb-8">
						<h2 className="text-3xl font-bold text-[#40513B] mb-2">Sign In</h2>
						...
						<div className="flex items-center justify-between">
							<label className="flex items-center space-x-2 cursor-pointer">
								<input
									...
									onChange={handleChange}
									className="w-4 h-4 rounded border-[#9DC08B] text-[#609966] focus:ring-[#609966]"
								/>
								<span className="text-sm text-[#609966]">Remember me</span>
							</label>
					...
					<div className="my-8 flex items-center">
						...
						<span className="px-4 text-sm text-[#609966]">
							Or continue with
						</span>
						<div className="flex-1 h-px bg-[#9DC08B]/30"></div>
					</div>
					...
					<div className="mt-8 pt-8 border-t border-[#9DC08B]/20">
						<p className="text-sm text-[#609966] text-center mb-4">
							Join our growing community
						</p>
						<div className="grid grid-cols-3 gap-4">
							<div className="text-center p-3 bg-gradient-to-br from-[#EDF1D6] to-[#9DC08B]/20 rounded-xl">
								<p className="text-2xl font-bold text-[#40513B]">500+</p>
								<p className="text-xs text-[#609966]">Members</p>
							</div>
							<div className="text-center p-3 bg-gradient-to-br from-[#EDF1D6] to-[#9DC08B]/20 rounded-xl">
								<p className="text-2xl font-bold text-[#40513B]">1000+</p>
								<p className="text-xs text-[#609966]">Sightings</p>
							</div>
							<div className="text-center p-3 bg-gradient-to-br from-[#EDF1D6] to-[#9DC08B]/20 rounded-xl">
								<p className="text-2xl font-bold text-[#40513B]">45</p>
								<p className="text-xs text-[#609966]">Species</p>
							</div>
						</div>
					</div>
				</div>
